 ...
 * @author Shai Almog
 */
public class OmronAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "OmronApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new OmronAppStub());
    }
