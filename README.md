...
>In this project,  We did several attempts to make this code work in a real device. All off them didn't work. Even the connetion occours. Allways the timeout error happens.
